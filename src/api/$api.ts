...
import type { Methods as Methods2 } from './v1/contact'
import type { Methods as Methods3 } from './v1/musics'
import type { Methods as Methods4 } from './v1/musics/_id@string'
import type { Methods as Methods5 } from './v1/musics/category'
import type { Methods as Methods6 } from './v1/musics/search'
import type { Methods as Methods7 } from './v1/musics/search/category'
import type { Methods as Methods8 } from './v1/musics/utils/cms-webhook'
import type { Methods as Methods9 } from './v1/videos'
        ...
        v1: {
            ...
            musics: {
                ...
                category: {
                     ...
                     */
                    delete: (option: {
                        query: Methods5['delete']['query']
                        headers?: Methods5['delete']['reqHeaders'] | undefined
                        config?: T | undefined
                    }) =>
                        fetch<
                            Methods5['delete']['resBody'],
                            BasicHeaders,
                            Methods5['delete']['status']
                ...
                utils: {
                    cms_webhook: {
                        ...
                        post: (option: {
                            ...
                            headers?: Methods8['post']['reqHeaders'] | undefined
                            config?: T | undefined
                        }) =>
                            fetch<
